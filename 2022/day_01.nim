import std/[algorithm, re, strformat, sequtils, strutils, sugar]
import nimpy
...
echo fmt"Part 1: {CALORIES.max}"
echo fmt"Part 2: {CALORIES.sorted(cmp[int], order=SortOrder.Descending)[..2].foldl(a + b)}"